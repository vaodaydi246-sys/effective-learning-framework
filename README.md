...
Chào mừng bạn đến với **Effective Learning Framework** — Dự án mã nguồn mở tổng hợp và hệ thống hóa các phương pháp học tập dựa trên khoa học não bộ (Neuroscience). 

Mục tiêu của dự án này là giúp học sinh, sinh viên tối ưu hóa thời gian, tăng khả năng tập trung sâu (Deep Work) và ghi nhớ kiến thức vĩnh viễn.
...
## 🚀 Cách sử dụng ứng dụng hỗ trợ đếm giờ Pomodoro

Bạn có thể chạy trực tiếp ứng dụng mini-app đi kèm trong repository này:
1. Vào thư mục `tools/pomodoro-app/`.
2. Tải file `index.html` về máy tính.
3. Nhấp đúp chuột vào file, trang web đếm giờ 25 phút sẽ tự động chạy trên trình duyệt của bạn (Chrome, Edge, Safari) mà không cần cài đặt thêm phần mềm nào khác.
